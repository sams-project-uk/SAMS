...
namespace LARE
{
    ...
    void LARE3DST<T_EOS>::boundary_conditions()
    {
        bfield_bcs();
        energy_bcs();
        density_bcs();
    ...
    template<typename T_EOS>
    void LARE3DST<T_EOS>::bfield_bcs()
    {
    ...
    template<typename T_EOS>
    void LARE3DST<T_EOS>::energy_bcs()
    {
        auto &varRegistry = harness.variableRegistry;
    ...
    template<typename T_EOS>
    void LARE3DST<T_EOS>::density_bcs()
    {
        auto &varRegistry = harness.variableRegistry;
    ...
    template<typename T_EOS>
    void LARE3DST<T_EOS>::velocity_bcs()
    {
        auto &varRegistry = harness.variableRegistry;
    ...
    template<typename T_EOS>
    void LARE3DST<T_EOS>::remap_v_bcs()
    {
        auto &varRegistry = harness.variableRegistry;
