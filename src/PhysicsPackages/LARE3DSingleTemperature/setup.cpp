...
namespace LARE
{
    ...
    void LARE3DST<T_EOS>::registerAxes(SAMS::harness &harness)
    {
     ...
     */
    template<typename T_EOS>
    void LARE3DST<T_EOS>::registerVariables(SAMS::harness &harness)
    {
     ...
     */
    template<typename T_EOS>
    void LARE3DST<T_EOS>::allocate(SAMS::harness &harness, simulationData &data)
    {
        T_sizeType nx, ny, nz;
     ...
     */
    template<typename T_EOS>
    void LARE3DST<T_EOS>::grid(simulationData &data)
    {
