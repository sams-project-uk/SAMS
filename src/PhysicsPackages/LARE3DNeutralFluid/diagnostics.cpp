...
namespace LARE
{
    ...
    inline void LARE3DNF<T_EOS>::getHostVersion(simulationData &data, pw::portableArrayManager &manager, volumeArray &device, hostVolumeArray &host)
    {
    ...
    void LARE3DNF<T_EOS>::registerOutputMeshes([[maybe_unused]] writer<T_writer> &writer, [[maybe_unused]] simulationData &data){;}//No additional meshes

    template<typename T_EOS>
    template<typename T_writer>
    void LARE3DNF<T_EOS>::registerOutputVariables(writer<T_writer> &writer, simulationData &)
    {
    ...
    template<typename T_EOS>
    template<typename T_writer>
    void LARE3DNF<T_EOS>::writeOutputMeshes( [[maybe_unused]] writer<T_writer> &writer, [[maybe_unused]] simulationData &data){;}

    template<typename T_EOS>
    template<typename T_writer>
    void LARE3DNF<T_EOS>::writeOutputVariables(writer<T_writer> &writer, simulationData &data)
    {
...
//Instantiate the templates for HDF5 writer
    template void LARE3DNF<LARE::idealGas>::registerOutputMeshes<HDF5File>(writer<HDF5File> &writer, simulationData &data);
    template void LARE3DNF<LARE::idealGas>::registerOutputVariables<HDF5File>(writer<HDF5File> &writer, simulationData &data);
    template void LARE3DNF<LARE::idealGas>::writeOutputMeshes<HDF5File>(writer<HDF5File> &writer, simulationData &data);
    template void LARE3DNF<LARE::idealGas>::writeOutputVariables<HDF5File>(writer<HDF5File> &writer, simulationData &data);
#else
//Instantiate the templates for simple writer
    template void LARE3DNF<LARE::idealGas>::registerOutputMeshes<simpleFile>(writer<simpleFile> &writer, simulationData &data);
    template void LARE3DNF<LARE::idealGas>::registerOutputVariables<simpleFile>(writer<simpleFile> &writer, simulationData &data);
    template void LARE3DNF<LARE::idealGas>::writeOutputMeshes<simpleFile>(writer<simpleFile> &writer, simulationData &data);
    template void LARE3DNF<LARE::idealGas>::writeOutputVariables<simpleFile>(writer<simpleFile> &writer, simulationData &data);
#endif

    template<typename T_EOS>
    void LARE3DNF<T_EOS>::energy_correction(simulationData &data)
    {
        using Range = pw::Range;
        pw::applyKernel(
