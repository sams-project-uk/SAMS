...
namespace examples
{
     ...
     */
    void OrszagTang::attachBoundaryConditions(const std::string &varName, SAMS::harness &harness)
    {
     ...
     */
    void OrszagTang::controlVariables(LARE::LARE3D::simulationData &data)
    {
     ...
     * @param data LARE3D simulation data
     */
    void OrszagTang::setDomain(SAMS::harness &harness, LARE::LARE3D::simulationData &data)
    {
     ...
     * @param harness SAMS harness
     */
    void OrszagTang::setBoundaryConditions(SAMS::harness &harness)
    {
     ...
     * @param data LARE3D simulation data
     */
    void OrszagTang::initialConditions(SAMS::harness &harnessRef, LARE::LARE3D::simulationData &data)
    {
     ...
     */
    void OrszagTang::queryTerminate(bool &terminate, LARE::LARE3D::simulationData &data, SAMS::timeState &tData)
    {
     ...
     */
    void OrszagTang::queryOutput(bool &shouldOutput, LARE::LARE3D::simulationData &data, SAMS::timeState &tData)
    {
