...
namespace examples
{
     ...
     */
    void OrszagTang::controlVariables(LARE::simulationData &data)
    {
     ...
     * @param data LARE3D simulation data
     */
    void OrszagTang::setDomain(SAMS::harness &harness, LARE::simulationData &data)
    {
     ...
     * @param data LARE3D simulation data
     */
    void OrszagTang::initialConditions(SAMS::harness &harnessRef, LARE::simulationData &data)
    {
     ...
     */
    void OrszagTang::queryTerminate(bool &terminate, LARE::simulationData &data, SAMS::timeState &tData)
    {
     ...
     */
    void OrszagTang::queryOutput(bool &shouldOutput, LARE::simulationData &data, SAMS::timeState &tData)
    {
