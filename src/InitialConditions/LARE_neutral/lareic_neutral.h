#ifndef LAREIC_SHARED_DATA_NEUTRAL_H
#define LAREIC_SHARED_DATA_NEUTRAL_H
...
namespace LARE_neutral{
    ...
    class LARE3DInitialConditions{
        ...
        void setBoundary(const std::string& varName, bcFuncPtr bcFunc, SAMS::harness &harnessRef, simulationData &data, SAMS::timeState &timeStateRef){
            ...
            std::shared_ptr<SAMS::boundaryConditions> bcPtr = std::make_shared<LAREBoundaryConditions_neutral>(LAREBoundaryConditions_neutral(bcFunc, data, timeStateRef));
