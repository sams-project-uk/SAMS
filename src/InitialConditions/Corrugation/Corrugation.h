#ifndef CORRUGATION_H
#define CORRUGATION_H
...
namespace examples
{
    ...
    /**
     * Initial conditions, boundary conditions and domain setup for the Brio and Wu problem
     */
    ...
    private:
        ...
        inline static constexpr auto nameType = SAMS::constexprName("Corrugation") + T_EOS::name;
    ...
    #define EOS_DEF(value) template class Corrugation<value>;
    EOS_DENSITY_ENERGY
    #undef EOS_DEF
