...
namespace examples
{
        ...
        void TwoFluidTest::controlVariables(LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral)
        {
            ...
            dataNeutral.x_min = data.x_min;
            dataNeutral.x_max = data.x_max;
            dataNeutral.y_min = data.y_min;
            dataNeutral.y_max = data.y_max;
            dataNeutral.z_min = data.z_min;
            dataNeutral.z_max = data.z_max;
            ...
            // Geometry options: cartesian, cylindrical, spherical
            dataNeutral.geometry = LARE_neutral::geometryType::Cartesian;
            // Shock viscosity coefficients
            ...
            data.eta0 = 2.e-10;
            // Resistive MHD options
            dataNeutral.resistiveMHD = false;
            dataNeutral.eta_background = 1.e-10;
            dataNeutral.j_max = 1.0;
            dataNeutral.eta0 = 2.e-10;
         ...
         * @param data LARE3D simulation data
         */
        void TwoFluidTest::setDomain(SAMS::harness &harness, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral) 
        {
         ...
         * @param data LARE3D simulation data
         */
        void TwoFluidTest::initialConditions(SAMS::harness &harnessRef, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral)
        {
        
            //char shock_tube_problem[8]="sod";
            //char shock_tube_problem[8]="briowu";
            
            if (std::strcmp(data.shock_tube_problem,"sod")==0){
            ...
            if (std::strcmp(data.shock_tube_problem,"briowu")==0){
                // Brio & Wu Shock tube
       ...
       /**
         ...
         */
        void TwoFluidTest::queryTerminate(bool &terminate, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral, SAMS::timeState &tData){
