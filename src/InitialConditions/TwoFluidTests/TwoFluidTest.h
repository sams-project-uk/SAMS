...
namespace examples
{
    ...
    public:
         ...
         */
        void controlVariables(LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral);
         ...
         * @param data LARE3D simulation data
         */
        void setDomain(SAMS::harness &harness, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral);
         ...
         * @param data LARE3D simulation data
         */
        void initialConditions(SAMS::harness &harnessRef, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral);
       ...
       /**
         ...
         */
        void queryTerminate(bool &terminate, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral, SAMS::timeState &tData);
        ...
        * @param tData SAMS time state data
         ...
         */
        void queryOutput(bool &shouldOutput, LARE::simulationData &data,LARE_neutral::simulationData &dataNeutral, SAMS::timeState &tData);
