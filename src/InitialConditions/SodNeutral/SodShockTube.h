#ifndef SODSHOCKTUBEN_H
#define SODSHOCKTUBEN_H
...
namespace examples
{
    ...
    private:
        ...
        inline static constexpr auto nameType = SAMS::constexprName("SodShockTubeNeutral") + T_EOS::name;
    ...
    public:
         ...
         * @param data LARE3D simulation data
         */
        void setDomain(SAMS::harness &harness, LARE::LARE3DST<T_EOS>::simulationData &data);
        ...
        * @param tData SAMS time state data
         ...
         */
        void queryOutput(bool &shouldOutput, LARE::LARE3DST<T_EOS>::simulationData &data, SAMS::timeState &tData);

    };

    #define EOS_DEF(value) template class SodShockTubeNeutral<value>;
    EOS_DENSITY_ENERGY
    #undef EOS_DEF

}
#endif // SODSHOCKTUBEN_H