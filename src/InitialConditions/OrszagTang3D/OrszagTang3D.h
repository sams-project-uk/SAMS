#ifndef ORSZAGTANG3D_H
#define ORSZAGTANG3D_H
...
namespace examples
{
    ...
    /**
     * Initial conditions, boundary conditions and domain setup for the Orszag-Tang Vortex problem
     */
    ...
    private:
        ...
        inline static constexpr auto nameType = SAMS::constexprName("OrszagTang3D") + T_EOS::name;
    ...
    #define EOS_DEF(value) extern template class OrszagTang3D<value>;
    EOS_DENSITY_ENERGY
    #undef EOS_DEF
